...
ls -lA
cat sbom.json
#jq '.packages[]? | {"sbom":{packagename:.name,versionInfo:.versionInfo,licenseDeclared:.licenseDeclared,downloadLocation:.downloadLocation,licenseConcluded:.licenseConcluded,copyrightText:.copyrightText,SPDXID:.SPDXID,copyrightText:.copyrightText}}' sbom.json > sbom_output.json
#ls -lA
#mkdir sbom_chunks
#ls -lA
#echo "Dir done"
